...
export const recipes = [
  ...
  {
    id: 'pao-artesanal-alveolado',
    name: 'Pão Artesanal Alveolado',
    image: `${imageBase}Pao-Artesanal-Alveolado.png`,
    breadWeight: 780,
    ingredients: {
      farinha: 100,
      agua: 74,
    ...
    instructions: [
      'Misture a farinha com 700g da água até não restar farinha seca.',
      'Deixe em autólise por 1 hora.',
      'Adicione o fermento, o sal e o restante da água.',
      ...
      'Leve a massa para fermentação lenta na geladeira entre 12 e 24 horas.',
      'Retire da geladeira e faça uma pré-modelagem delicada sem expulsar o gás.',
      'Descanse por 20 minutos.',
      'Faça a modelagem final tensionando levemente a superfície.',
      'Deixe fermentar entre 1 e 2 horas.',
      'Faça cortes profundos antes de assar.',
      'Asse em forno pré-aquecido a 250°C com vapor inicial.',
      'Asse cerca de 20 minutos com vapor e finalize sem vapor até dourar.',
    ],
  },
];
